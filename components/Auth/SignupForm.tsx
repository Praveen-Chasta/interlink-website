...
export default function SignUpSignIn() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row justify-center items-center overflow-hidden bg-[#FAF9FB]">
    {/* Left section with image */}
        <div className="w-[90%] h-auto hidden lg:flex lg:w-1/2 lg:items-center lg:justify-center bg-gradient-to-br p-6">
        ...
        <div className="flex w-full lg:w-1/2 items-center justify-center px-6 lg:px-0 h-[80vh]">
            ...
            <div className="flex gap-4 mb-6 bg-white rounded-full w-[60%] mx-auto shadow-md">
                <button
