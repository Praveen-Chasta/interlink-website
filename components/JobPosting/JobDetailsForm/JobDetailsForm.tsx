  ...
  return (
      <div className="flex flex-col items-start justify-start p-6 bg-[#FAF9FB] max-w-screen max-h-screen w-full h-full min-h-screen">
           <div className="flex items-center gap-x-3"> 
             ...
             <div className="w-full lg:max-w-[90%] xl:max-w-[94%] mx-auto">
                  <div className="mt-5">
                  ...
                  <div className="h-auto mt-8 flex">
                        {/* Timeline Left Side */}
                        <div className="w-44 p-6 bg-white h-[90%] rounded-lg border border-[#E4E4E4]">
                        ...
                        <div ref={formRef} className="flex-1 p-6 bg-white h-[66vh] rounded-lg border border-[#E4E4E4] ml-4 overflow-y-auto">
